...
import colombiaMain from './colombia-main.jpg'

export const article = {
  author: 'Luka Petrovic & Raffaele Consorti',
  date: '2023-11-15',
  title: 'Colombia - Tutto quello che devi sapere per il tuo viaggio',
  description:
    'Stai pensando di visitare la Colombia? Ecco tutto quello che devi sapere per organizzare il tuo viaggio in questo meraviglioso paese sudamericano.',
}
